...
public class XMLFactory {
    ...
    public static XmlPullParser newPullParser(File file) throws XmlPullParserException {
        XmlPullParser parser = newPullParser();
        try {
            parser.setInput(new FileChannelInputStream(file), com.abdurazaaqmohammed.AntiSplit.main.LegacyUtils.UTF_8.name());
    ...
    public static XmlPullParser newPullParser(InputStream inputStream) throws XmlPullParserException {
        XmlPullParser parser = newPullParser();
        parser.setInput(inputStream, com.abdurazaaqmohammed.AntiSplit.main.LegacyUtils.UTF_8.name());
        return parser;
    }
    ...
    public static XmlSerializer newSerializer(OutputStream outputStream) throws IOException{
        XmlSerializer serializer = newSerializer();
        serializer.setOutput(outputStream, com.abdurazaaqmohammed.AntiSplit.main.LegacyUtils.UTF_8.name());
        return serializer;
    }
