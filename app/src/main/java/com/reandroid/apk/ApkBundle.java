...
//            }
        ...
        if(!TextUtils.isEmpty(s)) {
            ...
            act.getHandler().post(() ->
                    act.styleAlertDialog(new AlertDialog.Builder(context).setTitle(rss.getString(R.string.warning)).setMessage(rss.getString(R.string.mismatch, s.replaceFirst(", ", "")))
                            .setPositiveButton("OK", (dialog, which) -> {
                                ...
                                if(Build.VERSION.SDK_INT < 16) act.finish();
                                else act.finishAffinity();
                                latch.countDown();
                            })
